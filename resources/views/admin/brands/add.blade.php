                            ...
                            <div class="card-body">
                                ...
                                <form  action="{{ route('brand.store') }}" method="post">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Masukan Nama Brand" required>
                                        @error('name')
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="slug" class="form-control" placeholder="Masukan Slug Brand" required>
                                        @error('slug')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
